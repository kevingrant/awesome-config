...
for i = #tags.names + 1, tagcount do
    ...
    table.insert(tags.layout, awful.layout.suit.floating)
end
...
clientkeys = awful.util.table.join(
    awful.key({ modkey,           }, "w",      function (c) c.fullscreen = not c.fullscreen  end),
...
function run_once(prg,arg_string,pname,screen)
    ...
    if not arg_string then
        awful.util.spawn_with_shell(
          "pgrep -u $USER -x '" .. pname .. "' || (" .. prg .. ")",screen)
    else
        awful.util.spawn_with_shell(
          "pgrep -u $USER -x '" .. pname .. " ".. arg_string .."' || (" .. prg .. " " .. arg_string .. ")",screen)
    end
end
